            ...
            middlewares.push({
                ...
                middleware: (req, res) => {
                    ...
                    const compileDoneHook = debounce((stats) => {
                        ...
                        let shouldContentScriptsReload =
                            isContentScriptsUpdated && customOptions.enableContentScriptsAutoReload

                        if (customOptions.reloadContentOnBackgroundChange && shouldBackgroundReload) {
                            shouldBackgroundReload = false;
                            shouldContentScriptsReload = true
                        }
